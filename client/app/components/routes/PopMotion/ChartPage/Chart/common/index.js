...
import { defaultAxisStyles } from './defaultAxisStyles'
...
function createFormat (pattern = '%d-%b-%y') { // '%b %d') {
  return (
    TIMEFORMAT[pattern] || (
...
export function createScaleTextX (domain = [], s = 0) { // console.log('createScaleTextX()', domain, s)
  return scalePoint()
    .domain(domain)
    .range([0, s])
    .padding(0)
...
export function createScaleTextY (domain = [], s = 0) { // console.log('createScaleTextY()', domain, s)
  return scalePoint()
    .domain(domain)
    .range([0, s])
    .padding(0)
...
export function createScaleLinearX (domain = [], x = 0) { // console.log('createScaleLinearX()', domain, x)
  return scaleLinear()
    .domain(domain)
    .range([0, x])
}

export function createScaleLinearY (domain = [], y = 0) { // console.log('createScaleLinearY()', domain, y)
  return scaleLinear()
    .domain(domain)
    .range([y, 0])
}
